...
1. `01-background-glass.svg`
2. `02-back-glass-panel.svg`
3. `03-lock-shackle.svg`
4. `04-lock-body.svg`
5. `05-keyhole.svg`
6. `06-cloth.svg`
7. `07-sparkles.svg`
8. `08-glass-highlights.svg`

Each SVG uses the same `1024 x 1024` viewBox and transparent canvas, so the layers should align when stacked.
